...
{  // Always have this function, even with EEPROM_SETTINGS disabled, the current values will be shown
	...
	printf_P(PSTR(
		...
		echomagic, echomagic, cs.add_homing[X_AXIS], cs.add_homing[Y_AXIS], cs.add_homing[Z_AXIS], cs.extruder_type
             //cs.extruder_type was added by Keisuke
#else //TMC2130
	printf_P(PSTR(
		"%SSteps per unit:\n%S  M92 X%.2f Y%.2f Z%.2f E%.2f\n"
...
//192 -> 194 changed by Keisuke
static_assert (sizeof(M500_conf) == 194, "sizeof(M500_conf) has changed, ensure that EEPROM_VERSION has been incremented, "
...
static const M500_conf default_conf PROGMEM =
{
    ...
    {16,16,16,16},
#endif
    DEFAULT_EXTRUDER_TYPE, //added by Keisuke
};
